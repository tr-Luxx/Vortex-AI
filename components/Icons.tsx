...
export const IconSaturn = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" className={className}>
    <path fillRule="evenodd" clipRule="evenodd" d="M12 2.75a5.5 5.5 0 0 0-5.1 7.42c-2.85.25-5.15 1.54-5.15 3.08 0 1.7 2.8 3.1 6.3 3.1 3.5 0 6.3-1.4 6.3-3.1 0-.13-.02-.26-.05-.39A5.5 5.5 0 0 0 12 2.75zM12 10a2.5 2.5 0 1 1 0-5 2.5 2.5 0 0 1 0 5zm-3.26 3.16c.4-.64 1.4-1.2 2.6-1.52A5.5 5.5 0 0 0 16.3 12.5c-.32.22-.68.4-1.07.54-.78.27-1.8.44-2.89.44a8.62 8.62 0 0 1-3.6-.78z" />
    <path d="M22.58 11.23c-1.27-1.42-3.66-2.22-6.28-2.22-1.3 0-2.5.2-3.54.55a5.45 5.45 0 0 1 2.9 3.09c.2.03.41.05.62.05 3.5 0 6.3-1.4 6.3-3.1 0-.13-.02-.26-.05-.39.02.01.03.01.05.02zM7.2 16.48c.15-.02.3-.04.45-.07a5.45 5.45 0 0 1-2.9-3.09c-.2-.03-.41-.05-.62-.05-2.52 0-4.66.72-5.65 1.83 1.27 1.42 3.66 2.22 6.28 2.22.84 0 1.63-.08 2.37-.23.03 0 .05-.01.07-.01z" opacity="0.8"/>
  </svg>
);
...
export const IconStop = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" className={className}>
...
export const IconWaveform = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M4 10v4" />
    <path d="M8 8v8" />
    <path d="M12 4v16" />
